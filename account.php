    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container"> 
        ...
        <div class="navbar-header page-scroll">
          ...
          <a class="navbar-brand page-scroll" href="#main"><img src="images/logo1.jpg" width="80" height="30" alt="iLand" /></a> </div>
      ...
      <div class="container nopadding">
        <div class="col-md-12">
          <div class="hero-content text-center">
            <h1 class="wow fadeInUp" data-wow-delay="0.1s">gETTo gET TO know</h1>
            <p class="wow fadeInUp" data-wow-delay="0.2s"> "Where one click is communication" </p>
            <a href="#" class="btn btn-action wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Sorry !</a> </div>
        </div>
      </div>
    </div>
    <!-- Classes Section -->
