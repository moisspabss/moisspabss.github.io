...
<div id="header">
    ...
    <!-- /Twitter -->
    	...
    	<div class="nav">
			...
			<ul><li><a HREF="index.php" class="navstyle " title="Home"><span>Home</span></a></li>
...
$result = mysql_query("SELECT * FROM messages WHERE recipient='" . $user."' AND status='$status'");
	...
	?></span></a></li>
                ...
                <li> <a href="forums.php" class="navstyle "><span>Forums</span></a>                </li>
...
<a href="trashmessages.php" style="text-decoration:none;">Back to Messages</a>
